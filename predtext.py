...
def build_train_model(config):
    ...
    bert_path = f"./checkpoint/{config['dataset']}_bert_text"
    ...
    mlgn.load_state_dict(torch.load(f"./checkpoint/{config['dataset']}_bert_text/student_model_file.bin"))
...
if __name__ == '__main__':
    ...
    filename = "./results/pre_bert_text.json"
